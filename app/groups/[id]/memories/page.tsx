  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        {preview && (
          <div className="bg-gray-900 rounded-2xl p-6 border border-violet-500 mb-8">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-violet-500 mb-4"
            />
            {uploadError && (
        ...
        {memories.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 text-lg">No memories yet</p>
            <p className="text-gray-600 text-sm mt-2">Upload your first photo or video</p>
            <button
              onClick={() => fileInputRef.current?.click()}
              className="mt-6 px-6 py-3 bg-violet-600 hover:bg-violet-500 rounded-xl font-semibold transition-colors"
            >
              Upload a memory
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {memories.map(memory => (
              <div
                ...
                className="relative group cursor-pointer rounded-2xl overflow-hidden bg-gray-900 aspect-square"
              >
      ...
      {selectedMemory && (
        ...
        >
          <div
            className="max-w-3xl w-full bg-gray-900 rounded-2xl overflow-hidden"
          ...
          >
            ...
            <div className="p-4">
              {selectedMemory.caption && (
                <p className="text-white mb-2">{selectedMemory.caption}</p>
              )}
